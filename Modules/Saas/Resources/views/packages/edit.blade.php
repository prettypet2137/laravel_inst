...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">@lang('Update package')</h1>
</div>
<div class="row">
    <div class="col-md-3">
            ...
            <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="number" required min="1" step="1" name="interval_number" value="{{ $package->interval_number }}" class="form-control" placeholder="@lang('Package num time')">
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <select name="interval" class="form-control">
                                    <option value="day" {{ $package->interval == 'day' ? 'selected' : '' }}>@lang('Day')</option>
                                    <option value="week" {{ $package->interval == 'week' ? 'selected' : '' }}>@lang('Week')</option>
                                    <option value="month" {{ $package->interval == 'month' ? 'selected' : '' }}>@lang('Month')</option>
                                    <option value="year" {{ $package->interval == 'year' ? 'selected' : '' }}>@lang('Year')</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" required min="-1" step="1" name="settings[no_events]" value="{{ $package->settings['no_events'] }}"  class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <small>@lang('(Enter -1 for unlimited)')</small>
                                <input type="number" required min="-1" step="1" name="settings[no_guests]" value="{{ $package->settings['no_guests'] }}" class="form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <label class="custom-control custom-checkbox">
                                    <input type="checkbox" name="is_featured" value="1" class="custom-control-input" {{ $package->is_featured ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <label class="custom-control custom-checkbox">
                                    <input type="checkbox" name="is_active" value="1" class="custom-control-input" {{ $package->is_active ? 'checked' : '' }}>
                ...
                <div class="card-footer">
                    <div class="d-flex">
                        ...
                        <button class="btn btn-primary ml-auto">@lang('Update package')</button>
                    </div>
                </div>
            </div>
        </form>
