                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-7">
                                        @php 
                                            $template = $reminder->getTemplate(); 
                                        @endphp
                                        @if (empty($template) || $template->type == "default")
                                            <form action="{{ route('email.user.templates.store') }}" method="POST">
                                        @elseif ($template->user_id == $user->id)
                                            <form action="{{ route('email.user.templates.update', $template->id) }}" method="POST">
                                                @method('put')
                                        @endif
                                                @csrf
